...
function Template
{
  ...
  then
    ...
    echo "No supported jinja2 tool found!" >&2
    exit 1
  fi
...
function Collections_custom
{
  ...
  Collection_files=$(ls .collections .collections.j2 ${Roledir}/*/.collections ${Roledir}/*/.collections.j2 2>/dev/null)
